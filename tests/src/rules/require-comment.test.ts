...
ruleTester.run(name, rule, {
  ...
  invalid: [
    ...
    {
      name: 'reports a comment without a value',
      code: '<Trans comment>Hello</Trans>',
      errors: [{ messageId: 'emptyComment' }],
    },
    {
      name: 'reports a non-string comment',
      code: '<Trans comment={true}>Hello</Trans>',
      errors: [{ messageId: 'emptyComment' }],
    },
    {
    ...
    {
      name: 'reports a non-string comment property',
      code: 't({ message: "Hello", comment: true })',
      errors: [{ messageId: 'emptyComment' }],
    },
    {
    ...
    {
      name: 'reports a non-string context when allowContext is enabled',
      code: '<Trans context={true}>Order summary</Trans>',
      options: [{ allowContext: true }],
      errors: [{ messageId: 'missingCommentJsx' }],
    },
    {
      name: 'reports a non-string context property when allowContext is enabled',
      code: 't({ message: "Order summary", context: true })',
      options: [{ allowContext: true }],
      errors: [{ messageId: 'missingCommentCall' }],
    },
  ],
